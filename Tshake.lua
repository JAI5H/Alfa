...
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "الفا")
ArrayRdods = {
"تراك ازعجتنا",
...
local Text = [[ 
Source Fast
[DEV MAHMOUD](t.me/AKJA0)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ↗️',url="t.me/otlop12"}}, 
{{text = 'مالك السورس ↗️', url="t.me/AKJA0"}}, 
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "الفاx")
